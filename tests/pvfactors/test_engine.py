...
from  xm_solarlib.pvfactors.irradiance import IsotropicOrdered, HybridPerezOrdered
from  xm_solarlib.pvfactors.irradiance.utils import breakup_df_inputs
from  xm_solarlib.pvfactors.viewfactors.calculator import VFCalculator
import numpy as np
...
def test_check_direct_shading_continuity():
    ...
    # Update 2021-10-04 for v1.5.2: for xm_solarlib <0.9.0, expected value
    # was [20.497127, 20.50229]. The values changed slightly because
    # of a bugfix to the Perez model in xm_solarlib 0.9.0. See pvfactors PR #121.
