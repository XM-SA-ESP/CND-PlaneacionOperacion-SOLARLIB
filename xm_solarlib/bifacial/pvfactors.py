...
def pvfactors_timeseries(params: PvfactorsTimeseriesParams):
    ...
    solar_azimuth: numeric
        Sun's azimuth angles using xm_solarlib's azimuth convention (deg)
    solar_zenith: numeric
        Sun's zenith angles (deg)
    surface_azimuth: numeric
        Azimuth angle of the front surface of the PV modules, using xm_solarlib's
        convention (deg)
    surface_tilt: numeric
        Tilt angle of the PV modules, going from 0 to 180 (deg)
    axis_azimuth: float
        Azimuth angle of the rotation axis of the PV modules, using xm_solarlib's
