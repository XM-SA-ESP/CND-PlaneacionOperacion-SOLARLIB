...
# patch spa.c
with open(os.path.join(DIRNAME, SPAC_C), 'rb') as f:
    SPA_C = f.read()
...
with open(os.path.join(DIRNAME, SPAC_C), 'wb') as f:
    f.write(SPA_C)
...
SPA_SOURCES = [os.path.join(DIRNAME, src) for src in ['spa_py.pyx', SPAC_C]]
